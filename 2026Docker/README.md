...
| `ARG` | ビルド時のみ有効な変数 | `ARG VERSION=1.0` |
...
# ② 環境変数を設定
#    PYTHONUNBUFFERED=1: Python の出力をリアルタイムで表示
...
### 6-4. .dockerignore ファイル

`.gitignore` の Docker版です。ビルドコンテキストから除外するファイルを指定します。
